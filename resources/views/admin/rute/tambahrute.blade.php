...
@section('title','Siopbus - Tambah Rute')
@section('sidebar')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-8">
                ...
                <div class="card-body">
                    <form class="user" method="post" action="/insertrute" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group row">
                            <div class="col-lg-12 mb-3 mb-sm-0">
                                <input type="text" class="form-control" name="kode" placeholder="Kode Rute" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <input type="text" class="form-control" name="asal" placeholder="Kota Asal" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <input type="text" class="form-control" name="tujuan" placeholder="Kota Tujuan" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-12 mb-3 mb-sm-0">
                                <select class="custom-select form-control" name="jalur" id="jalur" required>
                                    <option hidden>Via Jalur</option>
