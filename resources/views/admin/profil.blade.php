    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-8">
                ...
                <div class="card-body">
                    <form class="user" method="post" action="/updateprofil" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="text-center">
                        <label><input type="file" class="custom-file-input" id="foto" name="foto">Ganti Foto Profil ? Klik disini</label>
                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <input type="text" class="form-control" name="nama" placeholder="Nama Lengkap" value="{{$data->nama}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-12">
